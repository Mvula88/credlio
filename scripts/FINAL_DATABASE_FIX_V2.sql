-- ============================================
-- FINAL DATABASE FIX V2 - RUN THIS SCRIPT
-- ============================================
...
-- ============================================
-- STEP 6: Check countries table structure and populate
-- ============================================
...
BEGIN
    ...
    RAISE NOTICE 'Countries table has columns: %', col_list;
END $$;

-- Insert countries (only using columns that exist)
