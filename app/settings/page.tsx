...
import { Loader2, User, Mail, Phone, Globe, Shield, CreditCard, LogOut } from "lucide-react"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-4">You will be redirected to the login page after signing out.</p>
              <Button onClick={handleSignOut} variant="destructive" className="w-full" disabled={signingOut}>
                {signingOut ? (
                  <>
