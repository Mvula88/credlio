    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge variant={type === "loan" ? "default" : "secondary"}>
          {type === "loan" ? "Loan Issued" : "Repayment"}
        </Badge>
      )
    },
  },
    ...
    cell: ({ row }) => (
      <DataTableRowActions
        ...
        actions={[
          ...
          {
            label: "Send Reminder",
            onClick: (data) => console.log("Remind", data),
          },
        ]}
      />
    ),
...
export function LenderDashboardClient({
  profile,
  subscription,
  countryCode,
  hasActiveSubscription,
  subscriptionTier,
}: LenderDashboardClientProps) {
      ...
      <div className="container mx-auto max-w-7xl px-4 py-8">
        ...
        <Breadcrumb className="mb-4">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/lender">Lender</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
        ...
        {hasActiveSubscription ? (
          <Tabs defaultValue="overview" className="space-y-6">
            ...
            <TabsContent value="overview" className="space-y-6">
              ...
              {/* Recent Transactions with Data Table */}
              <Card>
                <CardHeader>
                  <CardTitle>Recent Transactions</CardTitle>
                  <CardDescription>Your latest lending activity and repayments</CardDescription>
                </CardHeader>
                <CardContent>
                  <DataTable
                    columns={columns}
