-- Minimal Setup for Off-Platform Defaulters and Ghost Borrower Tracking
-- This version doesn't depend on the is_risky column in borrower_profiles
...
-- 11. Create simplified unified risk view (without risky borrowers for now)
...
-- 12. Create function to get risk summary for a person
...
-- 13. Add triggers to auto-update ghost loan status
